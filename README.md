...
- `CODE_OF_CONDUCT.md`, `CONTRIBUTING.md`, `SECURITY.md`, `SUPPORT.md`, which
  propagate to any repo lacking its own copy.
- `.github/ISSUE_TEMPLATE/`, the default bug report and feature request
  forms, plus `config.yml`.
